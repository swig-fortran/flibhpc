...
The following standalone codes demonstrate how Flibhpc can be used in native
Fortran code.
...
This pure-Fortran module builds on top of functionality from Flibhpc. It
provides procedures to:

 - Format and print the Flibhpc version;
